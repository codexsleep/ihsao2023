                                ...
                                <form action="" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="nama" class="form-control" id="nama" name="nama"
                                            aria-describedby="nama" placeholder="Masukkan Nama Admin"
                                            value="<?= $adminData['name']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="email" class="form-label">Email</label>
                                        <input type="email" class="form-control" id="email" name="email"
                                            aria-describedby="email" placeholder="Masukkan Email Admin"
                                            value="<?= $adminData['email']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="password" class="form-label">Password</label>
                                        <input type="password" class="form-control" id="password" name="password"
                                            aria-describedby="password" placeholder="Masukkan Password Admin">
