            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Semua Admin <a href="<?= base_url(); ?>admin/administrator/tambah"
                                ...
                                <tbody>
                                    ...
                                    foreach ($admin as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url(); ?>admin/administrator/edit/<?= $value['id']; ?>"
                                                    class="btn btn-warning btn-sm waves-effect waves-light"><i
                                                        class="mdi mdi-lead-pencil"></i></a>
                                                <a href="<?= base_url(); ?>admin/administrator/hapus/<?= $value['id']; ?>"
