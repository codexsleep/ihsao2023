                                ...
                                <form action="" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="nama" class="form-control" id="nama" name="nama"
                                            aria-describedby="nama" placeholder="Masukkan Nama peserta"
                                            value="<?= $peserta['nama']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="email" class="form-label">Email</label>
                                        <input type="email" class="form-control" id="email" name="email"
                                            aria-describedby="email" placeholder="Masukkan Email Peserta"
                                            value="<?= $peserta['email']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="nis" class="form-label">Nis</label>
                                        <input type="nis" class="form-control" id="nis" name="nis"
                                            aria-describedby="nis" placeholder="Masukkan Nis Peserta"
                                            value="<?= $peserta['nis']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="sekolah" class="form-label">Asal Sekolah</label>
                                        <input type="sekolah" class="form-control" id="sekolah" name="sekolah"
                                            aria-describedby="sekolah" placeholder="Masukkan Asal Sekolah"
                                            value="<?= $peserta['asal_sekolah']; ?>" required>
                                    </div>
