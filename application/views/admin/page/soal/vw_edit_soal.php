                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="" method="POST" enctype="multipart/form-data">
                                            <div class="mb-3">
                                                ...
                                                <textarea id="myTextarea" name="pertanyaan"><?= $soal['question'];?></textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Pilihan A</label>
                                                <textarea id="myTextarea" name="opsia"><?= $soal['option_a'];?></textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Pilihan B</label>
                                                <textarea id="myTextarea" name="opsib"><?= $soal['option_b'];?></textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Pilihan C</label>
                                                <textarea id="myTextarea" name="opsic"><?= $soal['option_c'];?></textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Pilihan D</label>
                                                <textarea id="myTextarea" name="opsid"><?= $soal['option_d'];?></textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Pilihan E</label>
                                                <textarea id="myTextarea" name="opsie"><?= $soal['option_e'];?></textarea>
                                            </div>
                                            <div class="mb-3">
                                                        <label class="form-label">Jawaban</label>
                                                        <select class="form-select" name="jawaban">
                                                            <option value="a" <?php if($soal['answare']=='a'){ echo "selected";}?>>A</option>
                                                            <option value="b" <?php if($soal['answare']=='b'){ echo "selected";}?>>B</option>
                                                            <option value="c" <?php if($soal['answare']=='c'){ echo "selected";}?>>C</option>
                                                            <option value="d" <?php if($soal['answare']=='d'){ echo "selected";}?>>D</option>
                                                            <option value="e" <?php if($soal['answare']=='e'){ echo "selected";}?>>E</option>
                                                        </select>
                                                    </div>
